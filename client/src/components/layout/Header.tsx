    ...
    <header className="h-16 bg-bg-secondary/80 backdrop-blur-md border-b border-border sticky top-0 z-40">
      <div className="h-full max-w-[1920px] mx-auto px-4 flex items-center justify-between">
        ...
        <Link to="/" className="flex items-center gap-3 group">
          <div className="w-10 h-10 bg-gradient-to-br from-accent-cyan to-accent-purple rounded-lg flex items-center justify-center group-hover:scale-105 transition-transform duration-200">
            <span className="text-xl font-bold text-bg-primary font-display">H</span>
          </div>
        ...
        <div className="flex items-center gap-4">
          {isAuthenticated ? (
            <>
              {/* Balance */}
              {account && (
                <div className="hidden sm:flex items-center gap-2 px-4 py-2 bg-bg-tertiary rounded-lg border border-border">
